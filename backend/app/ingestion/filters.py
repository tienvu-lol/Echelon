...
class IngestionPipeline:
    ...
    def __init__(self, strict_tech_only: bool = True):
        ...
        self.tech_keywords = {
            ...
            'cyber', 'security', 'systems', 'cloud', 'frontend', 'backend', 
            'fullstack', 'full-stack', 'product', 'qa', 'quant'
        }
        
        # Keywords that explicitly disqualify a role (e.g. non-tech internships)
        self.banned_keywords = {
            'marketing', 'sales', 'hr', 'human resources', 'legal', 
            'accounting', 'finance (non-quant)', 'business development'
        }
    ...
    def process_batch(self, raw_opportunities: List[Opportunity]) -> List[Opportunity]:
        ...
        logger.info(f"Ingestion Pipeline Results: Passed {len(filtered)} | "
