...
from app.services.eligibility_engine import evaluate_eligibility, INELIGIBLE

def get_top_candidates(profile: StudentProfile, preferences: CareerPreferences, all_opportunities: List[Opportunity] = None, limit: int = 40) -> List[Opportunity]:
    ...
    for opp in all_opportunities:
        ...
        for t in opp_tracks:
            if t in preferred_tracks:
                ...
                affinity = next((ct.weight for ct in opp.career_tracks if ct.track == t), 0.5)
